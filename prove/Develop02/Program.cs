...
class Program
{
    ...
    { 
        ...
        do
        {
            ...
            else if(CheckNumber ==2)//display
            {
                ...
                {
                    Console.Write(DateTime.Now.ToShortDateString());//<- write down the date
                    Console.WriteLine($" - Promt: {qa1.question} {qa1.answer}");//<- write down the quesiotn and answer from list
                }
            }
        ...
        public static void  SaveToFile(List<Write>questionAndAnswer)
        {
            ...
            using (StreamWriter outputFile = new StreamWriter(fileName))
            {
                foreach(Write qa1 in questionAndAnswer)
                {
                    outputFile.WriteLine($"{qa1.question},{qa1.answer}");
                }
            }
        }
        ...
        public static List<Write> ReadFromFile(string fileName)
    {
        ...
        foreach(string line in lines)
        {
            ...
            newWrite.question = parts[0];
            newWrite.answer = parts[1];    
